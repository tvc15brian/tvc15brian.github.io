...
var simpleGallery_navpanel={
	panel: {height:'50px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 10px Verdana'}, //customize nav panel container
	images: [ 'images/banner/left.gif', 'images/banner/play.gif', 'images/banner/right.gif', 'images/banner/pause.gif'], //nav panel images (in that order)
	imageSpacing: {offsetTop:[-4, 0, -4], spacing:10}, //top offset of left, play, and right images, PLUS spacing between the 3 images
	slideduration: 400 //duration of slide up animation to reveal panel
}
